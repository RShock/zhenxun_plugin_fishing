...
S2 独立增量游戏当前版本、设计思路、数值结果、已知问题和下一位 AI 的接手提示词，集中放在：

**[S2_NEXT_AI_HANDOFF.md](S2_NEXT_AI_HANDOFF.md)**

现行详细约束见 `doc/s2设计/星穹矿脉/vnext/DESIGN_INTENT.md`，当前回放与标定结果见 `doc/s2设计/星穹矿脉/vnext/INTERSTELLAR_PLAYTEST.md`。旧版设计文档保留用于追溯，不作为当前实现依据。
