...
from ..models import FishingGlobalConfig

_GROUP_ACTION_LIMIT_KEY = "group_action_limit_enabled"


async def is_group_action_limit_enabled() -> bool:
    """群聊收杆/钓鱼状态限流是否开启。"""
    return await FishingGlobalConfig.get_bool(_GROUP_ACTION_LIMIT_KEY, default=True)


async def set_group_action_limit_enabled(enabled: bool) -> None:
    """持久化设置群聊收杆/钓鱼状态限流开关。"""
    await FishingGlobalConfig.set_bool(_GROUP_ACTION_LIMIT_KEY, enabled)
