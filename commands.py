...
COMMAND_DEFS: tuple[CommandDef, ...] = (
    ...
    CommandDef(r"鱼店购买\s*(\S+)(?:\s+(\d+))?", "购买", "buy_matcher", ("鱼店购买",)),
    CommandDef(r"(?:增加展示栏位|升级展示栏|升级展示位|扩展展示栏|扩充展示栏|强化展示栏位|升级星空木框|星空木框|展示框|猫猫展示框|星空展示框)", "升级展示栏", "display_slot_matcher", ("升级展示栏", "增加展示栏位", "强化展示栏位")),
